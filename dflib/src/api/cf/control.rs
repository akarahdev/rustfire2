...
impl Control {
    ...
    pub fn return_from_function() {
        push_block(TemplateBlock::control("Return", ChestArgs::new()));
    }

    pub fn end_thread() {
        push_block(TemplateBlock::control("End", ChestArgs::new()));
    }

    pub fn skip_iteration() {
        push_block(TemplateBlock::control("Skip", ChestArgs::new()));
    }

    pub fn stop_repeat() {
        push_block(TemplateBlock::control("StopRepeat", ChestArgs::new()));
    }
}
